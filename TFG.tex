...
\usepackage{appendix}
%Márgenes
\usepackage[left=3cm,top=3cm,right=3cm,bottom=3cm, head=35pt]{geometry}
...
% Capitulo 8_parte2: Resultados de las pruebas en 2D
\include{capitulos/cap_resultados_2d}

% Capítulo Especial: Optimización del EKF
\include{capitulos/cap_optimizacion_kalman}

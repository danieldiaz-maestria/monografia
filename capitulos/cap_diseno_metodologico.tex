...
[COMPLETAR si se utiliza IMU: Para determinar la orientación del cuerpo humano y correlacionar las mediciones de ToF con el ángulo de orientación del cuerpo, se emplea una Unidad de Medida Inercial (IMU) que incorpora acelerómetro, giroscopio y magnetómetro...]
...
En cada posición de la malla, el participante adopta [ESPECIFICAR número] orientaciones diferentes, típicamente separadas por [ESPECIFICAR, ej. "45 grados"], completando así un ciclo de 360 grados. Esto permite evaluar el efecto del ángulo de orientación del cuerpo de manera sistemática.
...
\item Factor 2: Ángulo de orientación del cuerpo (8 niveles)

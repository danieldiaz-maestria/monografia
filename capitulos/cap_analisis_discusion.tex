...
\textbf{Régimen LOS (línea de vista directa):} La exactitud se mantiene baja a moderada, con MAE global promedio de 9.10 cm a través de todas las ubicaciones corporales en condiciones LOS. En las mejores configuraciones (cabeza y pecho), la exactitud alcanza 4.6-4.9 cm, comparable a los valores obtenidos en la calibración del sistema sin obstrucción. Esto confirma que cuando existe línea de vista directa, el cuerpo no interfiere significativamente con la propagación de la señal, y la exactitud depende principalmente de parámetros del hardware (cuantización temporal, ruido de receptor) y la geometría de posicionamiento.

\textbf{Régimen NLOS (sin línea de vista directa):} La obstrucción corporal introduce degradación significativa en la exactitud. El MAE global promedio en NLOS alcanza 50.46 cm, con variación considerable según ubicación: desde 18.16 cm (cabeza interior) hasta 97.76 cm (cadera interior), representando un rango de degradación de 2.0× a 13.6×. En estas configuraciones, las señales directas son severamente atenuadas, y los trayectos dominantes corresponden a difracción alrededor del cuerpo, propagación a través de tejido biológico con alta atenuación, o reflexiones en paredes. El retardo introducido por estos trayectos más largos se traduce directamente en sobreestimación de la distancia y variabilidad estadística aumentada, reduciendo la exactitud del sistema de manera proporcional a la severidad de la obstrucción corporal.

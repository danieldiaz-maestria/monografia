...
Los resultados experimentales pueden contrastarse con los modelos de simulación revisados en el capítulo de revisión sistemática de literatura.

El estudio de Otim et al. (2019) predijo mediante simulaciones FDTD que la atenuación por obstrucción corporal en UWB alcanzaría valores de 20-40 dB dependiendo de la ubicación del dispositivo y la orientación del cuerpo. Sus simulaciones sugirieron que la difracción alrededor del cuerpo humano introduce retardos adicionales equivalentes a errores de distancia de 30-80 cm en condiciones NLOS. Nuestros resultados experimentales en 6.5 GHz corroboran este rango, obteniendo MAE de 32.43 cm (cabeza, NLOS exterior) hasta 94.78 cm (cadera, NLOS exterior), confirmando las predicciones del modelo FDTD.

Sin embargo, las simulaciones de Otim et al. no capturaron completamente la variabilidad inter-ubicación observada experimentalmente. El modelo FDTD utilizó un maniquí homogéneo simplificado, mientras que nuestras mediciones con sujetos reales revelan que la heterogeneidad del tejido biológico y la variabilidad postural introducen dispersión estadística significativa (desviación estándar 10-71 cm en NLOS según ubicación). Esto sugiere que modelos de simulación más sofisticados con anatomía realista multi-tejido serían necesarios para predecir con exactitud la distribución completa del error, no solo su valor medio.

El trabajo de Fan et al. (2019) empleó simulaciones de canal UWB en MATLAB para caracterizar condiciones NLOS, reportando que características espectrales de la señal (ancho de pulso, amplitud del primer arribo) permitían clasificar LOS vs NLOS con exactitud superior al 90\%. Este hallazgo es consistente con nuestras observaciones: la diferencia en MAE entre LOS (4.6-8.3 cm) y NLOS (18-95 cm) es suficientemente marcada para que técnicas de detección NLOS basadas en características de señal sean viables, aunque no implementadas en este estudio.
...
El trabajo experimental de Sasaki et al. sobre BS en UWB-WBANs reportó atenuación máxima de 30 dB para señales que atraviesan el torso. Asumiendo que 30 dB de atenuación adicional puede resultar en pérdida completa de detección del primer arribo y dependencia en trayectos difractados, esto es consistente con nuestros errores máximos observados de 1.5-2.9 m en cadera NLOS, donde la señal directa es completamente bloqueada por torso y pelvis.

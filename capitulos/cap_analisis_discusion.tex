...
\begin{enumerate}
\item \textbf{Tamaño muestral limitado:} Con 3 participantes, la generalización de las conclusiones sobre la influencia de características antropométricas debe tomarse con cautela. Estudios futuros con mayor número de participantes permitirían análisis estadísticos más robustos.

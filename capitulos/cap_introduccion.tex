...
\end{figure}
%
El nodo móvil o etiqueta (TAG) puede transmitir la distancia calculada al nodo fijo o ancla (ANCHOR) en un mensaje final, si es necesario \cite{ref13}.
...
El trabajo de maestría considera un IPS compuesto por cuatro nodos fijos o anclas (ANCHORS) y un nodo móvil o etiqueta (TAG), ubicado en distintas partes del cuerpo humano, con el fin de analizar el desempeño de un IPS basado en UWB con BS. Con este propósito se plantea la siguiente pregunta de investigación.

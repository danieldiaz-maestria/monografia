...
Con base en el análisis de bondad de ajuste, se determinaron los parámetros óptimos para los modelos probabilísticos que describen el error de medición. Antes de presentar los valores específicos, se definen las tres distribuciones teóricas seleccionadas y la interpretación física de sus parámetros:

\begin{itemize}
    \item \textbf{Distribución Gamma:} Frecuentemente utilizada para modelar errores asimétricos positivos.
    \begin{equation}
    ...
    \item \textbf{Distribución Weibull:} Común en análisis de confiabilidad y tiempos de fallo.
    \begin{equation}
    ...
    \item \textbf{Distribución Log-normal:} Modela variables resultantes de procesos multiplicativos (como la atenuación por múltiples obstáculos).
    \begin{equation}

\chapter{FASE 4: PRUEBAS DE DESEMPEÑO DE ESTIMACIÓN DE DISTANCIA}
\label{ch:resultados}
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/exactitud_vs_precision_NLOS.png}
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/exactitud_vs_precision_nlos_pasillo.png}

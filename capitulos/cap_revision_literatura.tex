...
\begin{enumerate}
    ...
    Los autores investigan cómo la BS afecta la estimación de distancia basada en el ToF entre un nodo móvil y un nodo fijo y cómo las condiciones del cuerpo modifican el nivel del campo eléctrico recibido. Aunque no se mide la potencia recibida directamente, el análisis relaciona las variaciones del campo eléctrico incidente con las variaciones de la ganancia del receptor.

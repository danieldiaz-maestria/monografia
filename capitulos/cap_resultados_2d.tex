...
\hline
\rowcolor{headerblue}
\textbf{Estadística} & \textbf{LOS} & \textbf{NLOS} & \textbf{$\Delta$ (NLOS-LOS)} \\
\hline
ToF Promedio (ns) & 24.58 & 21.85 & -2.73 \\
ToF Mediana (ns) & 24.72 & 22.45 & -2.27 \\
ToF Desv. Std (ns) & 7.33 & 8.18 & 0.86 \\
ToF Rango (ns) & 28.52 & 42.86 & 14.35 \\
Desv. Std Promedio (ns) & 0.18 & 0.63 & 0.45 \\
...
\hline
\rowcolor{headerblue}
\textbf{Métrica} & \textbf{LOS} & \textbf{NLOS} & \textbf{Diferencia} \\
\hline
ToF Desv. Estándar (ns) & 7.50 & 8.07 & 0.57 \\
ToF Rango (ns) & 27.97 & 28.44 & 0.47 \\
Desv. Std Promedio (ns) & 0.10 & 0.09 & -0.02 \\
...
\textbf{Métrica} & \textbf{LOS} & \textbf{NLOS} & \textbf{Diferencia} \\
\hline
ToF Desv. Std (ns) - S1 & 7.34 & 7.62 & 0.28 \\
ToF Desv. Std (ns) - S2 & 7.22 & 7.47 & 0.25 \\
ToF Desv. Std (ns) - S3 & 7.31 & 8.22 & 0.91 \\
Desv. Std Prom (ns) - S1 & 0.21 & 0.61 & 0.40 \\
Desv. Std Prom (ns) - S2 & 0.18 & 0.59 & 0.40 \\
Desv. Std Prom (ns) - S3 & 0.19 & 0.97 & 0.78 \\
\hline
\end{tabular}
\end{table}
...
\textbf{Métrica} & \textbf{LOS} & \textbf{NLOS} & \textbf{Diferencia} \\
\hline
ToF Desv. Std (ns) - S1 & 7.40 & 8.36 & 0.95 \\
ToF Desv. Std (ns) - S2 & 7.22 & 9.08 & 1.86 \\
ToF Desv. Std (ns) - S3 & 7.28 & 8.20 & 0.92 \\
ToF Rango (ns) - S2 & 27.37 & 42.86 & 15.49 \\
Desv. Std Prom (ns) - S1 & 0.20 & 0.90 & 0.70 \\
Desv. Std Prom (ns) - S2 & 0.18 & 0.56 & 0.38 \\
Desv. Std Prom (ns) - S3 & 0.18 & 0.69 & 0.52 \\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[hbt]
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PruebasFinales/SALON/Resultados_Kalman/graficas_tof/pecho/sujeto1/pecho_sujeto1_ancla1_tof_sin_outliers.png}
        \\ (a) Ancla 1
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PruebasFinales/SALON/Resultados_Kalman/graficas_tof/pecho/sujeto1/pecho_sujeto1_ancla2_tof_sin_outliers.png}
        \\ (b) Ancla 2
    \end{minipage}
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PruebasFinales/SALON/Resultados_Kalman/graficas_tof/pecho/sujeto1/pecho_sujeto1_ancla3_tof_sin_outliers.png}
        \\ (c) Ancla 3
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PruebasFinales/SALON/Resultados_Kalman/graficas_tof/pecho/sujeto1/pecho_sujeto1_ancla4_tof_sin_outliers.png}
        \\ (d) Ancla 4
    \end{minipage}
    
    \caption{Distribución de ToF sin outliers para cada ancla - Pecho Sujeto 1. Se observa la diferenciación clara entre condiciones LOS y NLOS, con mayor dispersión temporal en NLOS.}
...
\item \textbf{Factor de peso:} Se recomienda aplicar peso de 0.28 a mediciones NLOS en algoritmos de trilateración
\end{itemize}

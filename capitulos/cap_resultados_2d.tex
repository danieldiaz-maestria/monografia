...
El análisis del Tiempo de Vuelo (ToF) permite caracterizar directamente la calidad de las mediciones de distancia en el sistema de posicionamiento 2D. En esta sección se presentan los resultados del análisis comparativo entre las condiciones LOS y NLOS para cada configuración evaluada.
